...
/// <summary>
/// Registers the named HTTP client used by <see cref="OpenAIEmbeddingClient" /> with Polly retry, circuit breaker, and timeout.
/// </summary>
public static class OpenAiEmbeddingHttpClientExtensions
{
    public static IHttpClientBuilder AddOpenAiEmbeddingHttpClient(this IServiceCollection services)
    {
        return services
            .AddHttpClient(OpenAIEmbeddingClient.HttpClientName, ConfigureClient)
